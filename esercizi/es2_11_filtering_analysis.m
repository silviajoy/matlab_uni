...
mseGFHighG = immse(img, gaussHighGF);
mseGFLowS = immse(img, sepLowGF);
mseGFHighS = immse(img, sepHighGF);
% median filter 
...
HighGaussian = [mseNoiseHighG; mseGFHighG; mseMFHighG];
LowSaP = [mseNoiseLowS; mseGFLowS; mseMFLowS];
HighSaP = [mseNoiseHighS; mseGFHighS; mseMFHighS];
%
% table %
